...
export const ProtocolSchemas: Record<string, TSchema> = {
  ...
  ConfigPolicyBundleApplyParams: ConfigPolicyBundleApplyParamsSchema,
  ConfigPolicyBundlesListParams: ConfigPolicyBundlesListParamsSchema,
  ConfigPolicyBundleResolveParams: ConfigPolicyBundleResolveParamsSchema,
  ConfigPolicyBundle: ConfigPolicyBundleSchema,
  ConfigPolicyBundlesListResult: ConfigPolicyBundlesListResultSchema,
  ConfigPolicyBundleResolveResult: ConfigPolicyBundleResolveResultSchema,
  ConfigChangesListParams: ConfigChangesListParamsSchema,
  ConfigChangesListResult: ConfigChangesListResultSchema,
  ...
  AuthzDeniedEvent: AuthzDeniedEventSchema,
  AuthzDeniedListParams: AuthzDeniedListParamsSchema,
  ...
  OwnershipGapsResult: OwnershipGapsResultSchema,
